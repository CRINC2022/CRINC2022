...
* **Data Preparation**
    - Download data into project root directory and uncompress them using
        ```
        wget https://wsnfg.oss-cn-shanghai.aliyuncs.com/web-bird.tar.gz
        tar -xvf web-bird.tar.gz
      
        # optional
        wget https://wsnfg.oss-cn-shanghai.aliyuncs.com/web-car.tar.gz
        wget https://wsnfg.oss-cn-shanghai.aliyuncs.com/web-aircraft.tar.gz
